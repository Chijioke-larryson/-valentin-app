export default function Header() {
    return (
        <header className="py-8 text-center px-4 z-20 relative">
            <h1 className="text-4xl md:text-6xl font-serif text-white font-bold mb-3 drop-shadow-lg tracking-tight">
